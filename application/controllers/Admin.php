...
class Admin extends MY_Controller {
        ...
        {
                $data=$this->fetch->getInfoByOrder('portfolio_category');
                $this->load->view('admin/adminheader',['title'=>'Portfolio category', 'data' => $data]); 
                $this->load->view('admin/adminaside'); 
        ...
        {
                $data=$this->fetch->getWorks();
                $this->load->view('admin/adminheader',['title'=>'Portfolio images', 'data' => $data]); 
                $this->load->view('admin/adminaside'); 
                $this->load->view('admin/portfolio-images'); 
                $this->load->view('admin/adminfooter');  
        }
