<div class="sub-header">
        ...
        <div class="container">
            <div class="row align-items-center flex-wrap-reverse">
                <div class="sub-header-content col-sm-6 pl-sm-5 pr-sm-4">
                        <h4 class="lato">Privacy Policy</h4>
                        <p>Read our terms & conditions and privacy policy to see how we handle your data.</p>
                </div>
    ...
    <section class="policy wow fadeInUp mb-5" data-wow-delay="0.6s">
        <div class="container mb-5">
            ...
            <p>Our Website links to other websites that may collect personally identifiable information about you. Aller Technologies is not responsible for the privacy practices or the content of those linked websites.</p>
            ...
            <p>If you want to remove your contact information from all Aller.in lists and newsletters, please visit unsubscribe</p>

            <h4>7. Advertisements on Aller.in</h4>
            ...
            <p>In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below: <br> <br>
            </p>
            <p class="info">
            Namrata Phatate, <br>
            Aller Technologies,<br>
            Esha House, Shree Datta Marg,<br>
            Sudarshan Nagar, Near Golande Ram Temple,<br>
            Chinchwad, Pune, Maharashtra 411033<br>
            Phone: 9765918881 <br>
            Email: info@aller.in <br>
            </p>
